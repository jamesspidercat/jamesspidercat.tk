...
function new_box(){
    var h = document.getElementById("list-holder");
    h.insertAdjacentHTML("beforeend", '<div class="list-item"><div class="item-content"><span class="order">5</span> Bravo</div></div>');
