...
<form name="logout" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
            ...
            <div class="row">
                <button type="submit" name="yes" class="btn btn-primary col-1 m-1" value="logout">Yes Please</button>
                <button type="submit" name="maybe" class="btn btn-primary col-1 m-1" value="unsure">I'm Not Sure</button>
                <button type="submit" name="no" class="btn btn-primary col-1 m-1" value="no">No Thanks!</button>
            </div>
    </form>
</div>
